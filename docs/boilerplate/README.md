...
3.  [Languages and technologies](./tech.md)
4.  [Routing, layouts, and views](./routing.md)
5.  [State management](./state.md)
6.  [Tests and mocking the API](./tests.md)
7.  [Linting and formatting](./linting.md)
8.  [Editor integration](./editors.md)
9.  [Building and deploying to production](./production.md)
