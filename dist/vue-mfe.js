...
(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('vue'), require('vue-router')) :
	typeof define === 'function' && define.amd ? define(['exports', 'vue', 'vue-router'], factory) :
	(factory((global.VueMfe = {}),global.Vue,global.VueRouter));
}(this, (function (exports,Vue,VueRouter) { 'use strict';
...
function createPageRouter(routes, config, mode) {
  ...
  var router = hasRouter ? addPortalRoutes(routes) : createRouter(routes, mode);
